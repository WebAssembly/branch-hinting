...
core_macros_def = "/" + main_conf_core_dir + "/util/macros.def"
...
assert(core_macros_def in rst_prolog)
print(rst_prolog)
rst_prolog  = rst_prolog.replace(main_macros_def, "/" + pwd + "/util/macros.def")
rst_prolog  = rst_prolog.replace(core_macros_def, "/" + core_dir + "/util/macros.def")
print(rst_prolog)
